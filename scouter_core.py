...
def compute_c_risk(wti, brent, gold, copper, silver=None, btc_chg=None,
    ...
    # G/C Ratio 수준 (regime 지표). 2026-06 재보정: 금 $4,000대 레짐에서 2년 실범위
    # 0.23~0.41(median 0.31)뿐 → 구식 0.35~0.55 미발화 → 0.32→0, 0.44→20, 캡 0.47.
    # 비율 지표라 저(低)G/C=경기 양호=정상적 0 (유가식 저레벨 floor 없음).
    gc_score = 0
    gc_ratio = None
